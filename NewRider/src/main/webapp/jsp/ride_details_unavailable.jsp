...
String fullName = firstname.substring(0,1).toUpperCase()+firstname.substring(1).toLowerCase() +" "+ lastname.substring(0,1).toLowerCase()+lastname.substring(1).toLowerCase();
...
<div id="container">
  ...
  <section class="spread">
            ...
            <ul id="rides">
                <li>
                    <h3 style="color: red;">Ride Details</h3>
                    <h5 style="color: red; text-decoration: underline;">Apologies, we couldn't retrieve the ride details at the moment.</h5>
                </li>
            </ul>
        </section>
</div>

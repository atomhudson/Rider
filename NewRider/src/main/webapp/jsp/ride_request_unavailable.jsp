...
<div id="container">
  ...
  <section class="spread">
            <h2>Available Request(s)</h2>
            <ul id="rides">
                <li>
                    <h3 style="color: red;">Ride Request(s)</h3>
                    <h5 style="color: red; text-decoration: underline;">Apologies, we couldn't retrieve the ride request at the moment.</h5>
                </li>
            </ul>
        </section>
</div>

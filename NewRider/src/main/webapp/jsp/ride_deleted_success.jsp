...
<div id="container">
  ...
  <section class="spread">
    <h2>Ride Offer Deleted Successfully</h2>
    <h3 style="color:green">Your Ride Offer Has Vanished into the Digital Ether - Deleted with a Click, Effortlessly!</h3><br>
    <button type="button" id="join" class="pill" onclick="window.location.href='index.jsp';"> &lt; Back</button>

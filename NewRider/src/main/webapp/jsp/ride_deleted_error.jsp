...
<div id="container">
  ...
  <section class="spread">
            <h3 style="color: red;">Ride Offer Deleteion Unsuccessful</h3>
            <ul id="rides">
                <li>
                    <a href="#" id="error-link" class="error-link"
                        style="color: sky-blue; text-decoration: underline;">Unsuccessful Journey: Your Ride Offer Vanished into the Digital Ether.</a>
                </li>
            </ul>

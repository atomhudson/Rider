...
String RideId = request.getAttribute("rideid").toString();
...
<div id="container">
  ...
  <section class="spread">
    <h2>Ride Offer Created Successfully</h2>
    <h3 style="color:green">Your Journey Begins: Ride Offer Successfully Crafted!</h3><br>
    <ul id="rides">
    <form action="jsp/ride_created_details.jsp" method="post">
    	<li>
    		<input type="hidden" name="rideid" value="<%=RideId%>">
    		<button type = "submit" class="pill">See the ride details</button>
    	</li>
    </form>	
    </ul>
  </section>

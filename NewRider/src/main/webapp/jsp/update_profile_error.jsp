...
<head>
  ...
  <title>Updating User Profile - Rider</title>
...
<div id="container">
  ...
  <section class="spread">
            ...
            <ul id="rides">
                <li>
                    <h3 style="color: red;">Update Profile Error</h3>
                    <a href="#" id="error-link" class="error-link"
                        style="color: sky-blue; text-decoration: underline;">Error while updating user progile</a>
                </li>
            </ul>
        </section>
</div>

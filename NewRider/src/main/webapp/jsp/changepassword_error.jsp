...
<html lang="en">
  <head>
    ...
    <title>Forget Password - Rider</title>
  ...
  <body>
    <div id="container">
      ...
      <section class="spread">
    	...
    	<h2 style="color:red;">Password(s) not Matched</h2>
    	<form action="./ChangePassword" method="POST">
        	<input type="password" name="pin" placeholder="Password" minlength="8" required>
        	<input type="password" name="pin2" placeholder="Confirm Password" minlength="8" required>
        	<input type="submit" value="Change Password" class="pill">
    	</form>
	</section>
    </div>
  </body>

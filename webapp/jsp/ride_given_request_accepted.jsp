...
<%@ page import="java.util.HashMap,java.util.ArrayList,java.sql.Connection,java.sql.DriverManager,java.sql.PreparedStatement,java.sql.ResultSet,java.sql.Time,javax.servlet.http.Cookie" %>
<%    
    ...
    ArrayList<String> email_request = (ArrayList<String>) request.getAttribute("email_request"); 
 %>    
...
<div id="container">
  ...
  <section class="spread">
    ...
    <div id="details-wrap">
      <ul>
        <%for(String email : email_request){%>
        <li class="requests">
          <%
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection c = DriverManager.getConnection("jdbc:mysql://localhost:3306/carpooling","root","password");
            ...
            String lname = null;
            if(rs.next()){
              Cookie cookie  = new Cookie("ride_takker",email);
          ...
          %>
        	  <form action="jsp/rider_profile_request.jsp" method="post" id="profileForm" style="display: inline-block;">
    				<input type="hidden" name="rider_email" value="<%= email %>">
